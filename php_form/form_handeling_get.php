		...
		<div class="row col-lg-8 offset-4">
			...
			<form action="" method="POST">
				...
				<div class="form-group">
					<button type="submit" name="submit" value="submit" class="btn btn-primary btn-block"> Create User List  </button>
				</div> 
			</form>
		</div>
		<div class="row col-lg-10 offset-4"><?php pre_r($_GET); ?></div>
	</div>
